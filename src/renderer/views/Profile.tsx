...
export default function Profile() {
  ...
  useEffect(() => {
    setTimeout(() => {
      setLoading(false);
      setNombre('Ramiro Racedo');
      setFecha('5/5/2005');
      setEdad('19');
      setTelefono('2972405941');
      setDireccion('No me la se');
      setImg(
  ...
  return (
    ...
    >
      ...
      {editando ? (
        ...
        <Typography className={loading ? 'skeleton' : ''}>{fecha}</Typography>
      )}
      {/* {editando ? (
      ...
      {editando ? (
        ...
        <Typography className={loading ? 'skeleton' : ''}>{edad}</Typography>
      )}
      {editando ? (
        <input
          value={telefono}
        ...
        <Typography className={loading ? 'skeleton' : ''}>{telefono}</Typography>
      )}
      {editando ? (
        <input
          value={direccion}
        ...
        <Typography className={loading ? 'skeleton' : ''}>{direccion}</Typography>
      )}
